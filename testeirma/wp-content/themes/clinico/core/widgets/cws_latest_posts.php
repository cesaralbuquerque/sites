...
class CWS_Latest_Posts extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		$query_args = array( 'posts_per_page' => 0, 'cat' => $category, 'no_found_rows' => true, 'post_status' => 'publish', 'ignore_sticky_posts' => true );
							...
							<li>
								<figure>
									<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'full' );
										if ( $image ) : ?>
										<img src="<?php echo bfi_thumb($image[0], array('width' => 76, 'height' => 76) ); ?>" alt="<?php echo esc_attr( get_the_title() ? get_the_title() : get_the_ID() ); ?>">
									<?php endif; ?>
...
?>
		...
		<!-- ICON SELECTION -->
				<?php $args = array('title_select'=>$title_select,'title_fa'=>$title_fa,'title_img'=>$title_img,'thumb_url'=>$thumb_url,'display_none'=>$display_none,'show_icon_options'=>$show_icon_options,'_this'=>$this);
