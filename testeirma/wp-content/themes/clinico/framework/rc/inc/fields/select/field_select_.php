	...
	*/
	function render(){
		...
		if( !empty( $this->field['data'] ) && empty( $this->field['options'] ) ) {
			...
			else if ($this->field['data'] == "fa-icons") {
				//$icons_file = ReduxFramework::$_dir.'inc/fields/select/fa-icons.php';
			}
			if ( !empty($icons_file) )
		...
		if ( !empty($this->field['data']) &&
				( $this->field['data'] == "elusive-icons" || $this->field['data'] == "elusive-icon" || $this->field['data'] == "elusive" || $this->field['data'] == "fa-icons" ) ) {
