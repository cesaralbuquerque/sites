					...
					<section class="news blog-post staff">
						<div class="item">
							<?php
								...
								$staff_info = array(
									'departments' => wp_get_post_terms( get_the_ID(), 'cws-staff-dept' ),
									'positions' => wp_get_post_terms( get_the_ID(), 'cws-staff-position'),
									'treatments' => wp_get_post_terms( get_the_ID(), 'cws-staff-treatments'),
									'procedures' => wp_get_post_terms( get_the_ID(), 'cws-staff-procedures'),
